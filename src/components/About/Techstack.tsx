...
const SkillIcon = ({ icon: Icon, name, proficiency, projects }: { icon: React.ElementType, name: string, proficiency: string, projects: string }) => {
  return (
    <div className="relative group cursor-pointer">
      ...
      {/* Tooltip */}
      <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 sm:w-56 bg-[#151421] border border-[#00e5ff]/30 shadow-[0_10px_30px_-10px_rgba(0,229,255,0.3)] rounded-xl p-4 z-50">
