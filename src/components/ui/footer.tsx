    ...
    <footer className="py-16 md:py-24 border-t border-white/5 bg-[#040108] relative overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl px-6 relative z-10 flex flex-col items-center">
        ...
        <HashLink
          ...
          to="/#top"
          aria-label="go home"
          className="mx-auto block size-fit group transition-transform duration-300 hover:scale-105"
        >
          <svg
            viewBox="0 0 100 100"
        ...
        {/* Navigation Links */}
        <div className="my-8 flex flex-wrap justify-center gap-6 md:gap-8 text-sm">
        ...
        <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
          ...
          {/* Send direct feedback or newsletter */}
          <HashLink
            smooth
            to="/contact#top"
        ...
        {/* Rights Section */}
        <span className="text-gray-500 block text-center text-sm font-light mt-4">
          {" "}
